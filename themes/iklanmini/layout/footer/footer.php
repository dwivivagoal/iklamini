<footer class="page-footer orange">
    <div class="container">
      <div class="row">
        <div class="col l6 s12">
          <h5 class="white-text">IklanMini.id</h5>
          <p class="grey-text text-lighten-4">Platform IklanMini.id pertama di Indonesia, Mudah Cepat dan Terpecaya. Baik untuk pencari barang/jasa/produk dan juga para pemasang iklan</p>
    ...
    <div class="footer-copyright">
      <div class="container">
      Made by <a class="orange-text text-lighten-3" href="http://dwihosting.com">dwihosting.com</a>
      </div>
    </div>
  </footer>
